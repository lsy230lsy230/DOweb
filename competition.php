                                            ...
                                            <div style="margin-top: 12px;">
                                                ...
                                                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                                    <?php if (isset($result['files']['detailed_report'])): ?>
                                                        <a href="/results_reports/<?= htmlspecialchars($result['comp_id'] ?? str_replace('comp_', '', $comp_id)) ?>/Event_<?= htmlspecialchars($result['event_no']) ?>/<?= htmlspecialchars($result['files']['detailed_report']) ?>" 
                                                           target="_blank" 
                                                    ...
                                                    <?php if (isset($result['files']['recall_report'])): ?>
                                                        <a href="/results_reports/<?= htmlspecialchars($result['comp_id'] ?? str_replace('comp_', '', $comp_id)) ?>/Event_<?= htmlspecialchars($result['event_no']) ?>/<?= htmlspecialchars($result['files']['recall_report']) ?>" 
                                                           target="_blank" 
                                                    ...
                                                    <?php if (isset($result['files']['combined_report'])): ?>
                                                        <a href="/results_reports/<?= htmlspecialchars($result['comp_id'] ?? str_replace('comp_', '', $comp_id)) ?>/Event_<?= htmlspecialchars($result['event_no']) ?>/<?= htmlspecialchars($result['files']['combined_report']) ?>" 
                                                           target="_blank" 
